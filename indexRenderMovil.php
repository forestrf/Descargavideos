...
<title>Descargar vídeos de Mitele, Antena 3, RTVE y más! - DescargaVideos.TV<?php echo $seccion==""?"":" - ".$seccion?></title>
...
<form action="/" method="get" name="formCalculador" id="formCalculador">
	<input type="text" name="web" id="web" class="entrada" placeholder="Pega aquí la URL del vídeo..." value="<?php if($web!="")echo htmlentities($web)?>" title="URL a obtener">
...
<?php if($resultado!="")
	echo '<div id="resultado" class="hx100">
		'.$resultado.'
		<script type="text/javascript">
