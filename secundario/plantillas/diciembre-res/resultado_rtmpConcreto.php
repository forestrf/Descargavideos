<b><i><div class="rtmpdump" id="rtmp<?php echo $R['random_id'];?>">rtmpdump {dir_resultado_rtmpdump_manual}</div></i></b>
...
<div class="agregar_rtmp_downloader" id="rtmp<?php echo $R['random_id'];?>df" style="display:none">
	...
	<form method="GET" action="http://127.0.0.1:25432/" id="rtmp<?php echo $R['random_id'];?>f" target="_blank">
		...
		<input type="hidden" name="url" value="<?php echo $R['dir_resultado_rtmpdump_manual_esc_doblecoma'];?>">
		<input type="hidden" name="command" value="rtmpdump <?php echo $R['dir_resultado_rtmpdump_manual_esc_doblecoma'];?>">
