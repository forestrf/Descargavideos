...
if(!defined('BOOKMARKLET'))
	...
	//define('BOOKMARKLET', "javascript:(function(d,s){s=d.createElement('script');s.type='text/javascript';s.src='//www.".DOMINIO."/js/bookmarklet.js';d.body.appendChild(s)})(document)");
