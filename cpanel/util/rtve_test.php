...
<table border=1><tr><td />
	...
	<br/><br/>
	Encriptado:<br/><textarea name="b" cols="50" rows="5"><?php echo encripta(isset($_POST["a"]) ? $_POST["a"] : '')?></textarea>
	<br/>
	...
	<br/><br/>
	Texto plano:<br/><textarea name="d" cols="50" rows="5"><?php echo desencripta(isset($_POST["c"]) ? $_POST["c"] : '')?></textarea>
	<br/>
