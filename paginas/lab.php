...
<div class="respuesta">
	...
	<?php echo TXT_VERSION_RECIENTE?>: <a href="https://github.com/forestrf/M3U8-Downloader/releases/download/v0.5.1/M3U8-Downloader.v0.5.1.zip">Descargar la última versión</a><br/><br/>
	<?php echo TXT_VERSION_HISTORIAL?>:<br/>
	0.5.1: <a href="https://github.com/forestrf/M3U8-Downloader/releases/download/v0.5.1/M3U8-Downloader.v0.5.1.zip">GitHub (zip)</a> | <a href="https://github.com/forestrf/M3U8-Downloader/releases/download/v0.5.1/M3U8-Downloader.v0.5.1.7z">GitHub (7z)</a><br/>
	0.5: <a href="https://github.com/forestrf/M3U8-Downloader/releases/download/v0.5/M3U8-Downloader.v0.5.zip">GitHub (zip)</a> | <a href="https://github.com/forestrf/M3U8-Downloader/releases/download/v0.5/M3U8-Downloader.v0.5.7z">GitHub (7z)</a><br/>
...
<div class="pregunta">
	<div id="lab_rtmp-downloader"></div>
	RTMP-Downloader
</div>
<div class="respuesta">
...
<div class="respuesta">
	...
	<?php echo TXT_VERSION_RECIENTE?>: <a href="https://github.com/forestrf/F4M-Downloader/releases/download/v0.0.5/F4M-Downloader.v0.0.5.zip">Descargar la última versión</a><br/><br/>
	<?php echo TXT_VERSION_HISTORIAL?>:<br/>
	0.0.5: <a href="https://github.com/forestrf/F4M-Downloader/releases/download/v0.0.5/F4M-Downloader.v0.0.5.zip">GitHub (zip)</a> | <a href="https://github.com/forestrf/F4M-Downloader/releases/download/v0.0.5/F4M-Downloader.v0.0.5.7z">GitHub (7z)</a><br/>
...
<div class="respuesta">
	<div class="creaform">
		...
		<script>
			...
			var a=46;//70,46,30
			var t="f2";//f1,f2,f3 (+ -)
			var c="blanco";//blanco, negro

			aplicaCambios();

			function aplicaCambios(que,con){
				if(que=='largo'){
					l=parseInt(con);
					if(l<100||l>9999)
						l=100;
...
<div class="pregunta">
	<div id="lab_forocoches"></div>
	<?php echo TXT_FOROCOCHES_TIT?>
</div>
<div class="respuesta">
	<?php echo TXT_FOROCOCHES_DESC?>
</div>