<div>
	...
	<a id="m3u8<?=$R2['random_id']?>a" class="Descarga" target="blank" href="http://127.0.0.1:25430/?url=<?php echo urlencode($R2['dir_resultado'])?>&pass=<?php echo urlencode($R2['pass_m3u8']);?>&headers=<?php echo urlencode($R2['headers']);?>">Descargar con M3U8-Downloader</a>
...
<div class="aviso_m3u8" id="m3u8<?=$R2['random_id']?>info">Este enlace require del programa JDownloader (<a href="http://jdownloader.org/download/index">Descargar</a>), o del programa M3U8-Downloader (<a href="/lab#lab_m3u8-downloader">Descargar</a>, <a href="http://www.youtube.com/watch?v=bqBBWumxp4c">tutorial en youtube</a>).<br/></div>
<script>
