...
function scrollToX(e,a,b,t,v,s){if(t<0||t>1||v<=0)return;k=t-1;e.scrollTop=a-(a-b)*(k*k*k+1);t+=v*s;setTimeout(function(){scrollToX(e,a,b,t,v,s);},s);}
...
if(!mueveMenu.m){
aC(mueveMenu.f,"menu_fixed");mueveMenu.m=1;
}
}
else if(mueveMenu.m){
qC(mueveMenu.f,"menu_fixed");
mueveMenu.m=0;
}
}
