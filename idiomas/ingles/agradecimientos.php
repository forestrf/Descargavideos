...
define("TXT_AGRADECIMIENTOS_FULL",'<a target="_blank" href="http://www.carballude.es/blog/2011/11/17/descargar-videos-de-telecinco-mitele-es-de-forma-manual/">Carballude</a>: Thanks to the post of the blog I was able to write the first script of the web, the first and only thing that I had on the web.
	...
	<p>Denobis (<a target="_blank" href="http://code.google.com/p/pydowntv/issues/detail?id=73">Info</a>): Thanks to him the quality and size of the RTVE videos is better.
	<p>Denobis (<a target="_blank" href="http://descargavid.blogspot.com.es/2013/11/segunda-solucion-para-atresplayer.html?showComment=1386788405636#c4282291989488164600">Info</a>): He indicated me how the videos of toon.tv works.
	<p>PyDownTV (<a target="_blank" href="http://www.pydowntv.com">Web</a>): It is thanks to they that ATresPlayer works in Descargavideos, fast to say but hard to do. It is a complex web with a lot of obstacles hard to break.
	<p>AOCarallo (<a target="_blank" href="http://aocarallo.crearforo.com">Web</a>): He was a beta tester of M3U8-Downloader until the program worked as it should, helping to solve the bugs, improve the program and other things.');
?>