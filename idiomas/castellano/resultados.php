<?php
define('INTERIOR_AVISO_RTMP','Windows: Necesitas el programa RTMP-Downloader para descargar este vídeo.<br/><a href="/lab#lab_rtmp-downloader">Descargar programa RTMP-Downloader</a>.<br/>
	<a href="http://www.youtube.com/watch?v=Jb0mt2qRXGw">video-tutorial en youtube</a>.<br/><br/>
	Mac OS X y GNU/Linux: El programa Easy-Rtmpdump de PyDownTV te permitirá descargar este vídeo.<br/><a href="http://www.pydowntv.com/ayuda#DescargarRtmpEasy">Descargar programa</a>.<br/>
	<a href="https://www.youtube.com/watch?v=Z-hsPc_Bb7A">video-tutorial en youtube</a>.<br/><br/>');
